...
from .resnet_hie import Bottleneck as _Bottleneck
from .resnet_hie import BasicBlock as _BasicBlock
from .resnet_hie import ResLayer, ResNetHIE
...
class BasicBlock(_BasicBlock):
    ...
    def __init__(self,
                 ...
                 width_per_group=4,
                 **kwargs):
        super(BasicBlock, self).__init__(in_channels, out_channels, **kwargs)
        self.groups = groups
...
class ResNeXt3D(ResNetHIE):
    ...
    def __init__(self, depth, groups=32, width_per_group=4, **kwargs):
        self.groups = groups
        self.width_per_group = width_per_group
        super(ResNeXt3D, self).__init__(depth, **kwargs)
...
@BACKBONES.register_module()
class ResNeXtV1dHIE(ResNeXt3D):
    """ResNeXtV1d 3D backbone.
    ...
    def __init__(self, **kwargs):
        super(ResNeXtV1dHIE, self).__init__(
